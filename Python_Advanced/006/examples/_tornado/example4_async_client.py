...
# приклад ідентичний прикладу fetch1, але використовуємо async/await
...
# приклад ідентичний прикладу fetch2, але використовуємо callback-підхід
@gen.coroutine
def fetch3(url):
    http_client = AsyncHTTPClient()
...
# виконання кількох запитів у циклі for
@gen.coroutine
def fetch4(url):
    http_client = AsyncHTTPClient()
    responses = [
