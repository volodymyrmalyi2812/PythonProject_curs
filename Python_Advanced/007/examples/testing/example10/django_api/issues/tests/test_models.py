...
class IssueTestCase(TestCase):
    ...
    # маркуємо метод як `user`, що дозволить потім запускати тільки `user` тести
    @tag('user')
    ...
    def test_foo_debug_with(self):
        # перевизначаємо налаштування проекту в рамках методу та тестуємо метод
    ...
    def test_queryset(self):
        ...
        # підраховуємо кількість SQL запитів.
